...
const SocialIcons = ({ socialMedia }) => {
  // Simple icon mapping function - in a real app, you might use react-icons library
    ...
    <div className="flex justify-center space-x-8 py-4">
      {socialMedia.map((item, index) => (
        <a
          ...
          className="text-gray-500 dark:text-gray-400 hover:text-amber-500 dark:hover:text-amber-400
        ...
        >
          {getIconComponent(item.platform)}
        </a>
      ))}
    </div>
  );
